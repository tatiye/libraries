...
(function(n) { "function" === typeof define && define.amd ? define(["jquery", "datatables.net", "datatables.net-buttons"], function(u) { return n(u, window, document) }) : "object" === typeof exports ? module.exports = function(u, x, E, F) { u || (u = window);
    ...
    D.ext.buttons.csvHtml5 = {
        ...
        text: function(a) { return a.i18n("buttons.csv", '<i id="tdExcel"class="mdi mdi-file-excel"></i> <span id="tCsv">Csv</span>') },
        action: function(a, c, d, b) {
            this.processing(!0);
            a = S(c, b).str;
    ...
    D.ext.buttons.excelHtml5 = {
        ...
        text: function(a) {
            return a.i18n("buttons.excel", '<i id="tdExcel"class="mdi mdi-file-excel-box"></i> <span id="tExcel">Excel</span>')
        },
        action: function(a, c, d, b) {
            this.processing(!0);
            var m = this,
                ...
                t, h, q = function(k) {
                    ...
                    for (var l = 0, z = k.length; l < z; l++) {
                        ...
                        for (var N = 0, W = U.length; N < W; N++) { var L = U[N]; if (k[l].match && !k[l].match(/^0\d+/) && k[l].match(L.match)) { A = k[l].replace(/[^\d\.\-]/g, "");
                                L.fmt && (A = L.fmt(A));
                                A = y(f, "c", { attr: { r: G, s: L.style }, children: [y(f, "v", { text: A })] }); break } } A || ("number" === typeof k[l] || k[l].match && k[l].match(/^-?\d+(\.\d+)?([eE]\-?\d+)?$/) &&
