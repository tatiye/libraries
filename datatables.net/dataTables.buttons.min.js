...
(function(d) { "function" === typeof define && define.amd ? define(["jquery", "datatables.net"], function(z) { return d(z, window, document) }) : "object" === typeof exports ? module.exports = function(z, B) { z || (z = window);
    ...
    d.extend(x.prototype, {
        ...
        collectionRebuild: function(a, b) { a = this._nodeToButton(a); if (b !== p) { var c; for (c = a.buttons.length - 1; 0 <= c; c--) this.remove(a.buttons[c].node); for (c = 0; c < b.length; c++) { var e = b[c];
                    this._expandButton(a.buttons, e, e !== p && e.config !== p && e.config.split !== p, !0, e.parentConf !== p && e.parentConf.split !== p, c, e.parentConf) } } this._draw(a.collection, a.buttons) },
        ...
        destroy: function() { d("body").off("keyup." + this.s.namespace); var a = this.s.buttons.slice(),
            ...
            c = 0; for (b = a.length; c < b; c++)
                if (a.inst === this) { a.splice(c, 1); break } return this },
        enable: function(a, b) {
        ...
        _resolveExtends: function(a) {
            ...
            for (a = h(a); a && a.extend;) {
                ...
                if (l = a.prefixButtons) { a.buttons || (a.buttons = []);
                    ...
                    a.prefixButtons = null } a.extend = f.extend
            }
            return a
        },
    ...
    var K = function(a) {
        ...
        Q = function(a, b) {
            ...
            for (var g = b.length, l = [], m = 0, r = 0, q = 0 < g ? h.length / g : 0; r < q; r++) { for (var n = [g], k = 0; k < g; k++) n[k] = c.format.body(h[m], r, k, f[m]), m++;
                l[r] = n } b = { header: b, footer: e, body: l };
